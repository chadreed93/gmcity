SCHEMA.name = "GMCity" -- Change this name if you're going to create new schema.
SCHEMA.author = "Nate & SealsNetwork"
SCHEMA.desc = "Welcome to GMCity!"
...
nut.anim.setModelClass("models/player/zelpa/male_01_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_02_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_03_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_04_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_05_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_06_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_07_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_08_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_09_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_10_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_11_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_12_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_13_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/male_14_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_01_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_02_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_03_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_04_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_05_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_06_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_07_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_01_b_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_02_b_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_03_b_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_04_b_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_05_b_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_06_b_extended.mdl", "player")
nut.anim.setModelClass("models/player/zelpa/female_07_b_extended.mdl", "player")
